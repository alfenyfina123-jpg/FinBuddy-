...
import { Plus, Search, Trash2, Filter, ShoppingBag, ArrowUpRight, ArrowDownRight, X, QrCode, CreditCard, Banknote, Check, Hash, Calendar, User as UserIcon, TrendingUp, TrendingDown, ReceiptText, Package, DollarSign, Calculator, ChevronRight, AlertCircle, Sparkles } from 'lucide-react';
import { motion, AnimatePresence } from 'motion/react';
import { db, auth } from '../lib/firebase';
import { Transaction, OperationType, Product } from '../types';
