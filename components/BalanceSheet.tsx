...
import { FileStack, Download, ArrowUpRight, ArrowDownRight, Printer, Calculator, BarChart3, TrendingUp, Sparkles, Building2, Wallet, Calendar } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto space-y-12">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6 bg-white p-6 rounded-[2rem] border-2 border-slate-50 shadow-xl shadow-slate-100">
         <div className="flex items-center gap-4">
            ...
            <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight">Posisi Keuangan Per Tanggal</h3>
         </div>
